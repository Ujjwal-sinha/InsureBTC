...
import { idlFactory } from './icp_governance.did.js';
export { idlFactory } from './icp_governance.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_ICP_GOVERNANCE;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./icp_governance.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the icp_governance canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./icp_governance.did.js")._SERVICE>}
 */
export const icp_governance = createActor(canisterId);
