...
import { idlFactory } from './icp_pool.did.js';
export { idlFactory } from './icp_pool.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_ICP_POOL;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./icp_pool.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the icp_pool canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./icp_pool.did.js")._SERVICE>}
 */
export const icp_pool = createActor(canisterId);
