...
import { idlFactory } from './icp_cover.did.js';
export { idlFactory } from './icp_cover.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_ICP_COVER;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./icp_cover.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the icp_cover canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./icp_cover.did.js")._SERVICE>}
 */
export const icp_cover = createActor(canisterId);
