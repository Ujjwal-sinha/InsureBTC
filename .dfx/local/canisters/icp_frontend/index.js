...
import { idlFactory } from './icp_frontend.did.js';
export { idlFactory } from './icp_frontend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_ICP_FRONTEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./icp_frontend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the icp_frontend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./icp_frontend.did.js")._SERVICE>}
 */
export const icp_frontend = createActor(canisterId);
