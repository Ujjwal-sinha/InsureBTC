...
import { idlFactory } from './icp_bqbtc.did.js';
export { idlFactory } from './icp_bqbtc.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_ICP_BQBTC;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./icp_bqbtc.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the icp_bqbtc canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./icp_bqbtc.did.js")._SERVICE>}
 */
export const icp_bqbtc = createActor(canisterId);
